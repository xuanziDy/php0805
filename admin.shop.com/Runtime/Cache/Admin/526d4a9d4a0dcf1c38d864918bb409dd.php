...
<h1>
    ...
    <form action="<?php echo U();?>" name="searchForm" method="get">
        ...
        按商品类型显示:<?php echo arr2selected("goods_type_id",$goodsTypes,I('get.goods_type_id'));?>
...
<td align='center'><?php echo ($row["goods_type_id"]); ?></td>
<td align='center'><?php echo ($row["attribute_type"]); ?></td>
<td align='center'><?php echo ($row["attribute_input_type"]); ?></td>
<td align='center'><?php echo ($row["option_values"]); ?></td>
