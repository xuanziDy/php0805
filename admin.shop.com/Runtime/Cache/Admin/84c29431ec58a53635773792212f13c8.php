...
<div id="header-div">
    <div id="logo-div" style="bgcolor:#000000;">
        ...
        <h2 style="color: #ffffff;">韩国馆管理系统</h2>
    </div>
    <div id="submenu-div">
        <!--<ul>-->
...
<div id="menu-div">
    <ul>
        ...
        <li><a href="<?php echo U('OrderInfo/index');?>" target="main-frame">订单列表</a></li>
        ...
        <!--<?php echo dump(session('USERINFO'));?>-->
        <?php $var = $_SESSION['sess_']['USERINFO']; ?>
        <li><a href="javascript:;" target="main-frame"><?php echo ($var["username"]); ?></a></li>
