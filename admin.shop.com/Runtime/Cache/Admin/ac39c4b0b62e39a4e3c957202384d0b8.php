...
<h1>
    ...
    <div class="form-div">
        <form action="<?php echo U('OrderInfo/index');?>"  method="post" class="searchForm">
            <img src="http://admin.shop.com/Public/Admin/images/icon_search.gif" alt="SEARCH" border="0" height="22" width="26">
            ...
            <select name="pay_status" id="pay_status">
                ...
                <option value="1" <?php if(($pay_status) == "0"): ?>selected="selected"<?php endif; ?>>已付款</option>
            </select>
            发货状态
