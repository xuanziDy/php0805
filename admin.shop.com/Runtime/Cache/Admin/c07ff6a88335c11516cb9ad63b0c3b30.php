...
//                    $('.upload-goods-box img').attr('src',"__YPYUN__/"+data);     //云上图片的显示路径
	 ...
	 /////////////////////////////属性的开始   ////////////////////////////////////////////
            $('.goods_type_id').change(function(){
                ...
                $.getJSON('<?php echo U("Attribute/getByGoodsTypeId");?>',{goods_type_id:goods_type_id},function(rows){
            ...
            <?php if(!empty($id)): ?>//>>1.编辑的时候准备属性表单元素
                    var attributes = <?php echo ($attributes); ?>;
                    buildAttributeForm(attributes);
                   //>>2.要为表单元素赋值
                   var goodsAttributes = <?php echo ($goodsAttributes); ?>;
