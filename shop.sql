...
CREATE TABLE `goods` (
  ...
  KEY `name` (`name`),
  KEY `sn` (`sn`)
) ENGINE=InnoDB AUTO_INCREMENT=43 DEFAULT CHARSET=utf8 COMMENT='商品';

-- ----------------------------
-- Records of goods
-- ----------------------------
INSERT INTO `goods` VALUES ('35', '兰芝凝露', '2016051500000035', '51', '6', '15', '0', '2', '180.00', '200.00', '10', '1', '1', '补水 兰芝 凝露', 'goods/2016-05-31/574d5c3976c52.jpg', '1', '10', '2016-05-31 17:42:27');
INSERT INTO `goods` VALUES ('36', 'aa', '2016052000000036', '51', '6', '15', '0', '3', '12.00', '13.00', '0', '1', '7', '1', 'goods/2016-05-20/573f0a5170076.png', '1', '10', '2016-05-29 22:05:11');
INSERT INTO `goods` VALUES ('37', 'bbb', '2016052000000037', '51', '6', '15', '0', '2', '22.00', '22.00', '22', '1', '3', '22', 'goods/2016-05-20/573f1c8ecc9c4.png', '1', '10', '2016-05-20 22:18:17');
INSERT INTO `goods` VALUES ('41', '兰芝精华露', '2016052200000041', '46', '6', '15', '0', '3', '0.01', '0.02', '13', '1', '31', '精华', 'goods/2016-05-22/574134d9f2b65.jpg', '1', '10', '2016-05-31 14:50:59');
INSERT INTO `goods` VALUES ('42', '城野医生', '2016052200000042', '51', '7', '15', '0', '3', '112.00', '132.00', '12', '1', '2', '去角质，爽肤水', 'goods/2016-05-22/5741b8ecc2f11.jpg', '1', '10', '2016-05-22 21:50:23');
...
CREATE TABLE `shopping_car` (
  ...
  KEY `member_id` (`member_id`),
  KEY `goods_id` (`goods_id`)
) ENGINE=MyISAM AUTO_INCREMENT=35 DEFAULT CHARSET=utf8 COMMENT='购物车表';

-- ----------------------------
-- Records of shopping_car
-- ----------------------------
INSERT INTO `shopping_car` VALUES ('33', '23', '35', '1');
INSERT INTO `shopping_car` VALUES ('34', '23', '41', '2');
