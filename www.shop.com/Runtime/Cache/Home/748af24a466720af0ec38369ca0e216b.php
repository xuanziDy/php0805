		...
		<table>
			...
			<tbody>
				<?php if(is_array($shoppingCar)): $i = 0; $__LIST__ = $shoppingCar;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><tr>
						<td class="col1"  style="text-align: center"><a href=""><img src="http://admin.shop.com/Uploads/<?php echo ($item["logo"]); ?>" alt="" /></a>  <strong><a href=""><?php echo ($item["name"]); ?></a></strong></td>
						<td class="col2"  style="text-align: center">
							<?php echo ($item["goods_attributes"]); ?>
						</td>
						<td class="col3"  style="text-align: center">￥<span><?php echo ($item["shop_price"]); ?></span></td>
						<td class="col4"  style="text-align: center">
							<a href="javascript:;" class="reduce_num"></a>
							<input type="text" name="amount" value="<?php echo ($item["num"]); ?>" class="amount"/>
							<a href="javascript:;" class="add_num"></a>
						</td>
						<td class="col5"  style="text-align: center">￥<span><?php echo ($item['num']*$item['shop_price']); ?></span></td>
						<td class="col6"  style="text-align: center"><a href="<?php echo U('ShoppingCar/delete',array('id'=>$item['id']));?>">删除</a></td>
