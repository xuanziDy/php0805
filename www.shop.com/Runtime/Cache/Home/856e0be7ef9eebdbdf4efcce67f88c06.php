		...
		<div class="topnav_bd w990 bc">
			...
			<div class="topnav_right fr">
				<ul>
					...
					<li>您好<?php echo ($var["username"]); ?>，欢迎来到京西！<?php if(empty($var)): ?>[<a href="<?php echo U('Login/checkLogin');?>">登录</a>] [<a href="<?php echo U('Member/regist');?>">免费注册</a>]<?php else: ?>[<a href="<?php echo U('Login/logout');?>">注销</a>]<?php endif; ?> </li>
					<li class="line">|</li>
					<li>我的订单</li>
					<li class="line">|</li>
					<li>客户服务</li>
				...
				<table>
					...
					<tbody>
						<?php if(is_array($shoppingCars)): $i = 0; $__LIST__ = $shoppingCars;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><tr>
								<td class="col1"><a href=""><img src="http://admin.shop.com/Uploads/<?php echo ($item["logo"]); ?>" alt="" /></a>  <strong><a href=""><?php echo ($item["name"]); ?></a></strong></td>
								<td class="col2"> <p>颜色：073深红</p> <p>尺码：170/92A/S</p> </td>
								<td class="col3">￥<?php echo ($item["shop_price"]); ?></td>
								<td class="col4"><?php echo ($item["num"]); ?></td>
								<td class="col5"><span id="totle_money">￥<?php echo ($item['shop_price']*$item['num']); ?></span></td>
							</tr><?php endforeach; endif; else: echo "" ;endif; ?>
					</tbody>
					<tfoot>
						<tr>
