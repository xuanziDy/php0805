	...
	<div class="login w990 bc mt10">
		...
		<div class="login_bd">
			<div class="login_form">
				<form action="<?php echo U('Member/checkLogin');?>" method="post">
					<ul>
						<li>
							<label for="">用户名：</label>
						...
						<li class="checkcode">
							...
							<img src="<?php echo U('Verify/index');?>" style="cursor: pointer" onclick="this.src = '<?php echo U('Verify/index');?>?hhhhhh='+Math.random()"/>
