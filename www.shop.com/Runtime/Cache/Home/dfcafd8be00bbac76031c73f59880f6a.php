	...
	<div class="main w1210 mt10 bc">
		...
		<div class="breadcrumb">
			<h2>当前位置：
				...
				<?php if(is_array($goodsCategorys)): $i = 0; $__LIST__ = $goodsCategorys;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$goodsCategory): $mod = ($i % 2 );++$i;?><a href="<?php echo U('Index/lst',array('category_id'=>$goodsCategory['id']));?>"><?php echo ($goodsCategory["name"]); ?></a>&nbsp;>&nbsp;<?php endforeach; endif; else: echo "" ;endif; ?>
				<?php echo ($name); ?>
			</h2>
		</div>
		<!-- 面包屑导航 end -->
		...
		<div class="goods_content fl mt10 ml10">
			...
			<div class="summary">
				...
				<div class="preview fl">
					<div class="midpic">
						<a href="http://admin.shop.com/Uploads/<?php echo ($logo); ?>"  class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
							<img src="http://admin.shop.com/Uploads/<?php echo ($logo); ?>" width="300px;" alt="" />               <!-- 第一幅图片的中图 -->
						</a>
					</div>
					...
					<div class="smallpic">
						...
						<div class="smallpic_wrap">
							<ul>
								<?php if(is_array($paths)): $i = 0; $__LIST__ = $paths;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$path): $mod = ($i % 2 );++$i;?><li class=" <?php if(($i) == "1"): ?>curl<?php endif; ?> ">
										<a class="<?php if(($i) == "1"): ?>zoomThumbActive<?php endif; ?>" href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: 'http://admin.shop.com/Uploads/<?php echo ($path); ?>',largeimage: 'http://admin.shop.com/Uploads/<?php echo ($path); ?>'}"><img src="http://admin.shop.com/Uploads/<?php echo ($path); ?>" width="50px"></a>
				...
				<!--<div class="preview fl">-->
					<!--<div class="midpic">-->
						<!--<a href="http://admin.shop.com/Uploads/<?php echo ($logo); ?>" class="jqzoom" rel="gal1">   &lt;!&ndash; 第一幅图片的大图 class 和 rel属性不能更改 &ndash;&gt;-->
							<!--<img src="http://admin.shop.com/Uploads/<?php echo ($logo); ?>" alt=""  width="300px"/>               &lt;!&ndash; 第一幅图片的中图 &ndash;&gt;-->
						<!--</a>-->
					<!--</div>-->

					<!--&lt;!&ndash;使用说明：此处的预览图效果有三种类型的图片，大图，中图，和小图，取得图片之后，分配到模板的时候，把第一幅图片分配到 上面的midpic 中，其中大图分配到 a 标签的href属性，中图分配到 img 的src上。 下面的smallpic 则表示小图区域，格式固定，在 a 标签的 rel属性中，分别指定了中图（smallimage）和大图（largeimage），img标签则显示小图，按此格式循环生成即可，但在第一个li上，要加上cur类，同时在第一个li 的a标签中，添加类 zoomThumbActive  &ndash;&gt;-->
					...
					<!--<div class="smallpic">-->
						...
						<!--<div class="smallpic_wrap">-->
							<!--<ul>-->
								<!--<?php if(is_array($paths)): $i = 0; $__LIST__ = $paths;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$path): $mod = ($i % 2 );++$i;?>-->
									<!--<li <?php if(($i) == "1"): ?>class="cur"<?php endif; ?>  >-->
									<!--<a <?php if(($i) == "1"): ?>class="zoomThumbActive"<?php endif; ?> href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: 'http://admin.shop.com/Uploads/<?php echo ($path); ?>',largeimage: 'http://admin.shop.com/Uploads/<?php echo ($path); ?>'}"><img src="http://admin.shop.com/Uploads/<?php echo ($path); ?>" width="50px"></a>-->
									<!--</li>-->
				...
				<div class="goodsinfo fl ">
					...
					<form action="" method="post" class="choose">
						...
						<li>
							<dl>
								<dt>购买数量：</dt>
								<dd style="float:left;height:50px;">
									<a href="javascript:;" id="reduce_num"></a>
									<input type="text" name="num" value="1" class="amount"/>
									<a href="javascript:;" id="add_num"></a>
								</dd>
								<dd style="float:left;width:100px; padding-left:27px;color: #666666">库存量：<?php echo ($stock); ?>件</dd>
							</dl>
						</li>
							...
							<li>
								<dl>
									...
									<dd>
										...
										<?php if(($stock) <= "0"): ?><p style="width:154px;line-height:40px;background-color:#aaa;text-align: center;margin-left:75px;">暂时无货</p>
											<?php else: ?>
											<a href="javascript:;" class="add_btn" style="width:113px;height:34px; background:url('http://www.shop.com/Public/Home/images/p-btns.png')"></a><?php endif; ?>

										<!--<p style="color:red" class="car_num"></p>-->
									</dd>
								</dl>
							</li>
			...
			<div class="detail">
				...
				<div class="detail_bd">
					...
					<div class="comment detail_div mt10">
						...
						<?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="comment_items mt10">
								<div class="user_pic">
									<dl>
								...
								<div class="item">
									<div class="title">
										<span></span>
										<?php switch($vo["start"]): case "1": ?><!--好评-->
												<strong class="star star5"></strong><?php break;?>
											<?php case "2": ?><!--中评-->
												<strong class="star star3"></strong><?php break;?>
											<?php case "3": ?><!--差评-->
												<strong class="star star1"></strong><?php break; endswitch;?>
										<!--<strong class="star star5"></strong> &lt;!&ndash; star5表示5星级 start4表示4星级，以此类推 &ndash;&gt;-->
									</div>


									<div class="comment_content">
										<dl>
											<dt><?php echo ($vo["content"]); ?></dt>
											<?php if(!empty($vo["replay"])): ?><dt><font color="red"> 店家回复:<?php echo ($vo["replay"]); ?></font></dt><?php endif; ?>
					...
					<div class="after_sale mt15 none detail_div">
						...
						<div>
							<h3>服务承诺：</h3>
							<p>本商城向您保证所售商品均为正品行货，韩国馆自营商品自带机打发票，与商品一起寄送。凭质保证书及韩国馆发票，可享受全国联保服务（奢侈品、钟表除外；奢侈品、钟表由本商城联系保修，享受法定三包售后服务），与您亲临商场选购的商品享受相同的质量保证。本商城还为您提供具有竞争力的商品价格和运费政策，请您放心购买！</p> 
						...
						<div>
							<h3>权利声明：</h3>
							<p>本商城上的所有商品信息、客户评价、商品咨询、网友讨论等内容，是韩国馆重要的经营资源，未经许可，禁止非法转载使用。</p>
...
//
//			////////////////增加浏览次数  开始/////////////////////////////////
//			$.get('<?php echo U("Goods/addViewCount");?>',{goods_id:<?php echo ($id); ?>},function(){
//
//			});
//			////////////////增加浏览次数  结束/////////////////////////////////
//
//		})
		...
		$(function(){
			...
			$('.add_btn').click(function(){
				...
				$.post("<?php echo U('ShoppingCar/add');?>",form,function(data){
					if(data.status==2){
						window.location.href=data.url;
					}else if(data.status==1){
						$.post("<?php echo U('ShoppingCar/getCartNum');?>",form,function(data2){
							$('.car_num').html(data2);
						});
					}else{
						$('.car_num').html('加入购物车失败');
					}
				});
			});
			/*-----------------------商品介绍图片显示问题-----------------------------------*/
			$('.desc img').each(function(k,v){
//				console.debug($(v).attr('src'));
				var src='http://admin.shop.com'+$(v).attr('src');
				$(v).attr('src',src);
			});
		});
